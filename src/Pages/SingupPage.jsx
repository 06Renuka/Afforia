...
const SignupPage = () => {
  ...
  return (
    ...
    <div className='left_side' style={{float:'left',boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)'}}>
    ...
    <div className='Right_side'>
      <img style={{float:'right', border:'4px solid', borderColor:'black'}} src={rightsideimage} alt=''/>
    </div>
    </div>
  );
};
